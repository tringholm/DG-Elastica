// gradCurvMex computes the gradient of the discretized curvature term, used
// for adaptivity, in a C implementation
// 
// Input:
...
void gradcurv2(double *u, double *gradf, double epsilon, int Nx, int Ny);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    // ------------------------------------------ calculate gradient
    gradcurv2(u, gradf, epsilon, Nx, Ny);
...
void gradcurv2(double *u, double *gradf, double epsilon, int Nx, int Ny){
    ...
    int i,j,k,l,k_low,k_high,l_low,l_high,ind, ind2, ind3, ind4;
